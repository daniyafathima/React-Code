  ...
  return (
    <div className="w-full h-screen duration-200" style={{ backgroundColor: color }}>
      <div className="fixed flex flex-wrap justify-center bottom-12  px-12">
        <div className="flex flex-wrap justify-center gap-3 shadow-xl bg-white px-3 py-2 rounded-3xl"  style={{ backgroundColor: "gray" }}>
          ...
          <button onClick={() => { setColor("lavender") }} className="outline-none px-4 py-1 rounded-full text-white shadow-large " style={{ backgroundColor: "lavender" }}>Lavender</button>
        </div>
      </div>
    </div>
  )
